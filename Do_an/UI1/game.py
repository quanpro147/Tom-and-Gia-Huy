...
class Game:
    ...
    def button(self):
        ...
        volume_on = pygame.image.load('Do_an/button/volume_on.png').convert_alpha()
        volume_off = pygame.image.load('Do_an/button/volume_off.png').convert_alpha()
        ...
        volume_on_button = Button(520,160,volume_on,1)
        volume_off_button = Button(520,160,volume_off,1)
        ...
        return {'resume': resume_button, 
                ...
                'gameFrame':gameFrame,
                'delay': delay_button,
                'volume_on':volume_on_button,
                'volume_off':volume_off_button}
                ...
                while running_dfs:
                    ...
                    if pause:
                        if menu_state == 'menu':
                            ...
                            if(Vol == True):
                                self.buttons['volume_on_button'].draw(self.screen)
                                if(self.buttons['volume_on_button'].draw(self.screen)):
                                    Vol = False                          
                            else:
                                self.buttons['volume_off_button'].draw(self.screen)
                                if(self.buttons['volume_off_button'].draw(self.screen)):
                                    Vol = True
                ...
                while not running_dfs:
                    ...
                    if pause:
                        if menu_state == 'menu':
                            ...
                            self.delay = self.set_delay()
                            if(Vol == True):
                                self.buttons['volume_on'].draw(self.screen)
                                if(self.buttons['volume_on'].draw(self.screen)):
                                    Vol = False                          
                            else:
                                self.buttons['volume_off'].draw(self.screen)
                                if(self.buttons['volume_off'].draw(self.screen)):
                                    Vol = True                                                      
                            self.draw_text('{}'.format(self.algorithm), 'black', 560, 470)
                            if self.buttons['chang_alg'].draw(self.screen): # chang_alg
